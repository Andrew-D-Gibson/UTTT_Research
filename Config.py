config = {
    'mcts': {
        ...
        'pretrain_mcts_depth': 4096,  # iterations for raw (network-free) MCTS during pool generation - see GenerateRawMCTSExamples.py
    },

    'self_play': {
        'num_of_processes': 12,                     
        'num_of_self_play_games_per_process': 10, 
