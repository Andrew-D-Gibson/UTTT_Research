...
from simulate_gating_games import simulate_gating_games
from PlayerAgent import test_network_vs_mcts, test_raw_network_vs_random
...
class TrainingManager:
    ...
    def load_latest_training_examples(self, directory='TrainingExamples'):
        ...
        # have a higher N than this run's real latest (same footgun NetworkTournament.py
    ...
    def clone_network(self, network):
        ...
        # for free.
        tmp_path = 'Networks/_candidate_tmp.keras'
    ...
    def run_gating(self, candidate):
        ...
        candidate_path = 'Networks/_gating_candidate.keras'
        ...
        try:
            ...
            async_results = [
                pool.apply_async(simulate_gating_games,
                                  args=(candidate_path, 'Network.keras', size, start_index, progress_queue))
    ...
    def train(self):
        ...
        for episode in range(config['training']['num_of_episodes']):
            ...
            if promoted:
                ...
                self.network.save(f'Networks/Episode_{episode}.keras')
