...
Usage:
    python Interface.py human --network Network.keras --human-color x
    python Interface.py spectate --network1 Network.keras --network2 Network.keras
...
class InterfaceAgent:
    ...
    being locked to one PlayerAgent subclass (see PlayerAgent.py's
...
def parse_args():
    ...
    human.add_argument('--network', default='Network.keras')
    ...
    spectate.add_argument('--network1', default='Network.keras')
    spectate.add_argument('--network2', default='Network.keras')
