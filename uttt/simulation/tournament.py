...
from uttt.player.agent import ProbabilisticNetworkMCTSAgent, RolloutMCTSAgent, agent_game
...
# initializer), not once per game - mirrors uttt/simulation/gating.py loading its two
...
def play_tournament_game(agent_1_idx, agent_2_idx, game_index, progress_queue=None):
    ...
    # (same invariant uttt/simulation/gating.py/agent_match rely on).
